...
import pflichtaufgabe5.kunden.Privatperson;
import pflichtaufgabe5.kunden.Student;
import pflichtaufgabe5.transportmittel.Bahn;
import pflichtaufgabe5.transportmittel.Bus;
import pflichtaufgabe5.reiseanbieter.Reiseanbieter;
import pflichtaufgabe5.reiseanbieter.TuiReisen;
;
...
public class UnitTestReisen {
    ...
    public void testBusVNormal() {
        ...
        assertEquals(80.5, bus.getGescwindigkeit(), 0);
    ...
    public void testBahnVNormal() {
        ...
        assertEquals(110.5, bahn.getGescwindigkeit(), 0);
